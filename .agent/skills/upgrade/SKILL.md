...
```bash
if [ -d "$HOME//Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills/.git" ]; then
  INSTALL_TYPE="global-git"
  INSTALL_DIR="$HOME//Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills"
elif [ -d "$HOME/.gstack/repos/gstack/.git" ]; then
  INSTALL_TYPE="global-git"
  INSTALL_DIR="$HOME/.gstack/repos/gstack"
elif [ -d "/Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills/.git" ]; then
  INSTALL_TYPE="local-git"
  INSTALL_DIR="/Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills"
elif [ -d "/Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills/.git" ]; then
  INSTALL_TYPE="local-git"
  INSTALL_DIR="/Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills"
elif [ -d "/Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills" ]; then
  INSTALL_TYPE="vendored"
  INSTALL_DIR="/Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills"
elif [ -d "$HOME//Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills" ]; then
...
LOCAL_GSTACK=""
if [ -n "$_ROOT" ] && [ -d "$_ROOT//Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills" ]; then
  _RESOLVED_LOCAL=$(cd "$_ROOT//Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills" && pwd -P)
  _RESOLVED_PRIMARY=$(cd "$INSTALL_DIR" && pwd -P)
  if [ "$_RESOLVED_LOCAL" != "$_RESOLVED_PRIMARY" ]; then
    LOCAL_GSTACK="$_ROOT//Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills"
  fi
fi
...
```
Tell user: "Also updated vendored copy at `$LOCAL_GSTACK` — commit `/Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills/` when you're ready."
...
/Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills/bin/gstack-update-check --force 2>/dev/null || true
```
...
**If versions differ:** follow the Step 4.5 sync bash block above to update the local copy from the primary. Tell user: "Global v{PRIMARY_VER} is up to date. Updated local vendored copy from v{LOCAL_VER} → v{PRIMARY_VER}. Commit `/Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills/` when you're ready."
