...
_EXT_PATH=""
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
[ -n "$_ROOT" ] && [ -f "$_ROOT//Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills/extension/manifest.json" ] && _EXT_PATH="$_ROOT//Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills/extension"
[ -z "$_EXT_PATH" ] && [ -f "$HOME//Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills/extension/manifest.json" ] && _EXT_PATH="$HOME//Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills/extension"
