...
_UPD=$($GSTACK_BIN/gstack-update-check 2>/dev/null || /Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills/bin/gstack-update-check 2>/dev/null || true)
...
**If "Add as P0 TODO":**
- If `TODOS.md` exists, add the entry following the format in `review/TODOS-format.md` (or `/Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills/review/TODOS-format.md`).
...
1. Read `/Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills/review/checklist.md`. If the file cannot be read, **STOP** and report the error.
...
2. **Read `/Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills/review/design-checklist.md`.** If the file cannot be read, skip design review with a note: "Design checklist not found — skipping design review."
...
Read `/Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills/review/greptile-triage.md` and follow the fetch, filter, classify, and **escalation detection** steps.
...
Read `/Users/louisfghbvc/.gemini/antigravity/plugins/gstack/skills/review/TODOS-format.md` for the canonical format reference.
